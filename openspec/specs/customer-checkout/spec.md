<!-- Synced from `openspec/changes/admin-panel/specs/customer-checkout/spec.md` on 2026-07-05. Original change: admin-panel (4 chained PRs merged: PR #1..#4 on https://github.com/someonefrom93/jepwero). -->
